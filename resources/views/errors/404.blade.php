...
<div class="error">
  ...
  <div class="error__description">Halaman ini tidak ada, coba cek ulang ya...</div>
  <a href="{{route('dashboard')}}" class="error__button error__button--active">Dashboard</a>
  <a href="{{route('home')}}" class="error__button">Home</a>
</div>
