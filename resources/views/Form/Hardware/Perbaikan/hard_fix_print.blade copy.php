    ...
    <div class="mx-3 border-right border-left">
        ...
        <div id="Penyelesaian">
            <div id="PenyelesaianHeader" class="head bg-lightgray border-top font-bold">
                II. Detail Penyelesaian Masalah
            </div>
        ...
        <div id="SerahTerima">
            ...
            <div id="SerahTerimaDetail" class="border-top">
                <div class="row">
                    <div class="col-8">
                        <input type="checkbox">Diterima <input type="checkbox"> DiTolak <input type="checkbox">Dterima
                        Dengan Catatan
                    </div>
