...
@section('content')
    <div class="card card-shadow">
        <div class="card-body">
            ...
            <form method='post' action="{{ route('pro_up_tim') }}" enctype="multipart/form-data">
                {!! csrf_field() !!}
                @if ($errors->any())
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabtim" aria-labelledby="pills-home-tab">
                            <hr>
                            <div class="mb-3 row">
                                <label for="no_tim" class="col-sm-4 col-form-label">ID</label>
                                <div class="col-sm-8">
                                    <input type="text" required class="form-control" name="id" id="id" readonly value="{{$view->id}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="no_tim" class="col-sm-4 col-form-label">Nama</label>
                                <div class="col-sm-8">
                                    <input type="text" required class="form-control" name="tim_nama" id="tim_nama" value="{{$view->tim_nama}}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="no_cell" class="col-sm-4 col-form-label">Alias</label>
                                <div class="col-sm-8">
                                    <input type="text" required class="form-control" name="tim_alias" id="tim_alias" value="{{$view->tim_alias}}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer">
                <button class="btn btn-sm btn-primary shadow btn-block" type="submit">Update</button>
