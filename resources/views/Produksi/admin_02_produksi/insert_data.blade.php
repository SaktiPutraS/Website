...
@endsection
@section('main_header')
    Input Panel Produksi - {{$p3c_list->nomor_seri_panel}}
@endsection
@section('content')
    <div class="card card-shadow">
        ...
        <div class="card-body">
            ...
            <form method='post' action="{{ route('pn_02_store') }}" enctype="multipart/form-data">
                ...
                <hr>
                <div class="form-group">
                    <label class="form-label">SPV <span class="text-red">*Wajib</span></label>
                    <div class="selectgroup w-100">
                        <select required name="spv" id="spv" class="form-control" style="width: 100%">
                            ...
                            <option value="{{ $teams[$i]->id }}" >{{ $teams[$i]->Nickname }}</option>
                            @endfor
                        </select>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col">
                        <div class="form-group">
                            <label class="form-label">Tim Wiring <span class="text-red">*Wajib</span></label>
                            <div class="selectgroup selectgroup-pills" style="overflow: scroll; height: 200px;">
                                @for ($i = 0; $i < count($teams); $i++)
                                    <label class="selectgroup-item">
                                        <input type="checkbox" name="wiring[]" value="{{ $teams[$i]->Nickname }}" class="selectgroup-input">
                    ...
                    <div class="col">
                        <div class="form-group">
                            <label class="form-label">Tim Mekanik <span class="text-red">*Wajib</span></label>
                            <div class="selectgroup selectgroup-pills" style="overflow: scroll; height: 200px;">
                                @for ($i = 0; $i < count($teams); $i++)
                                    <label class="selectgroup-item">
                                        <input type="checkbox" name="mekanik[]" value="{{ $teams[$i]->Nickname }}" class="selectgroup-input">
                                        <span class="selectgroup-button">{{ $teams[$i]->Nickname }}</span>
                                    </label>
                                    @endfor
                            </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group mt-3">
                            <label for="" class="form-label">Status Komponen <span class="text-red">*Wajib</span></label>
                            <div class="form-group">
                                <!-- Radio buttons with labels "Lengkap" and "Kurang" -->
                                <label class="form-check">
                                <input type="radio" required name="status_komponen" value="Lengkap" id="Lengkap" /> Lengkap
                                </label>
                                <label class="form-check">
                    ...
                    <div class="col-6">
                        <div class="form-group mt-3">
                            <label for="" class="form-label">Status Pekerjaan <span class="text-red">*Wajib</span></label>
                            <div class="form-group">
                                <!-- Radio buttons with labels "Lengkap" and "Kurang" -->
                                <label class="form-check">
                                  <input type="radio" required class="status_pekerjaan" name="status_pekerjaan" value="Test-QC" id="Test-QC" /> Test QC
                                </label>
                                <label class="form-check">
                                  <input type="radio" class="status_pekerjaan"  name="status_pekerjaan" checked value="Progress" id="Progress" /> Progress
                                </label>
                                <label class="form-check">
                                  <input type="radio" class="status_pekerjaan"  name="status_pekerjaan" value="Tunda" id="Tunda" /> Tunda
                                </label>
                                <!-- Textarea input field, initially hidden -->
                ...
                <div id="QC_DONE">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local"  class="form-control" name="tgl_serah_ke_qc" id="tgl_serah_ke_qc">
                    </div>
                    {{-- <div class="mb-3 row">
