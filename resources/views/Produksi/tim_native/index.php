...
$tim=$conn->query("SELECT * FROM tim ");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="card mx-5 shadow mt-5">
                    <div class="card-body">
                    <table class="table table-striped" id="list_tim"style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $nomor=1;
                        while($row = $tim->fetch(PDO::FETCH_ASSOC)) { 	
                            // echo "<tr id='".$row['panel_seri']."'>";
                            echo "<tr id='target' oncontextmenu='rightClick()';return false;'>";
                            echo "<td>".$nomor++."</td>";
                            echo "<td>".$row['tim_nama']."</td>";
                            echo "<td>".$row['tim_alias']."</td>";
                            $change='confirm("Ingin hapus '.$row["tim_nama"].'")';
                            echo "<td><a class='text-primary' href='edit_tim.php?id=".$row['tim_id']."'><i class='bi bi-pencil-square'></i></a>
                            <a class='text-danger' onclick='return ".$change."'  href='destroy_tim.php?id=".$row['tim_id']."'><i class='bi bi-trash-fill'></i></a>
                            </td>";
