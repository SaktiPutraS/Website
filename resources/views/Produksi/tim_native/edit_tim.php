...
$sql="SELECT * FROM tim where tim_id=:id";
...
{
	$tim_nama = $row['tim_nama'];
	$tim_alias = $row['tim_alias'];
	$tim_id = $row['tim_id'];
    // session_start();
    // $message="";
...
<body>
    <div class="container-fluid bg-com">
        ...
        <div class="row">
            ...
            <!-- Content -->
            <div class="col">
                <h1 class="text-center text-shadow">Edit - <?php echo $tim_nama;?></h1>
                <!-- <?php echo $message; ?> -->
                <!-- Start Card -->
                <div class="card mx-5 shadow mt-5">
                    <div class="card-body">
                        ...
                        <form action="update_tim.php" method="post">
                            <div class="tab-content" id="pills-tabContent">
                                <!-- Menu1 -->
                                <div class="tab-pane fade show active" id="pills-home" role="tabtim" aria-labelledby="pills-home-tab">
                                    <hr>
                                    <div class="mb-3 row">
                                        <label for="no_tim" class="col-sm-4 col-form-label">Tim ID</label>
                                        <div class="col-sm-8">
                                            <input type="text" required readonly class="form-control" name="tim_id" id="tim_id" value="<?php echo $tim_id;?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="no_tim" class="col-sm-4 col-form-label">Nama</label>
                                        <div class="col-sm-8">
                                            <input type="text" required class="form-control" name="tim_nama" id="tim_nama" value="<?php echo $tim_nama;?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="no_cell" class="col-sm-4 col-form-label">Alias</label>
                                        <div class="col-sm-8">
                                            <input type="text" required class="form-control" value="<?php echo $tim_alias;?> "name="tim_alias" id="tim_alias">
                                        </div>
                                    </div>
