@extends('layout.main')
@section('title')
Update PO Lokal Track Bagian Finance
@endsection
@section('main_header')
    Update PO Lokal Track Bagian Finance
@endsection
@section('content')
    <div class="card card-shadow">
        <div class="card-header">
            <h4>Update Bagian Finance</h4>
        </div>
        <div class="card-body">
            <form method="post" enctype="multipart/form-data" action="{{route('lokal_procurement_3_store')}}">
                {!! csrf_field() !!}
                @if ($errors->any())
            ...
            <div class="form-group row">
                <div class="form-group col">
                    <label for="tanggal_terima_pi" class="form-label">Tanggal Terima dari PI</label>
                    <input required class="form-control" value="" name="tanggal_terima_pi" id="tanggal_terima_pi"type="date">
                </div>
                <div class="form-group col">
            ...
            <div class="form-group row">
                <div class="form-group col">
                    ...
                    <input required class="form-control" value="<?php echo date('Y-m-d')?>" name="tanggal_pembayaran" type="date">
                </div>
            ...
            <div class="form-group col">
                ...
                <button class="btn btn-secondary btn-block" type="submit" id="next">Submit</button>
        </form>
        </div>
    </div>
        ...
        function getData() {
           ...
           $.get('{{ route('lokal_procurement_getData') }}', {
               ...
               $.each($.parseJSON(response), function(key, value) {
                   ...
                   $("#tanggal_terima_pi").val(value.tanggal_serah_finance);
               });
           });
       }
   </script>
